          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <div className="max-w-[475px] w-full">
              <form onSubmit={handleSearch}>
                <div className="flex items-center border border-gray-3 rounded-[5px] bg-gray-1 overflow-hidden">
                  <input
                    type="search"
                    value={searchQuery}
                    ...
                    autoComplete="off"
                    className="w-full bg-transparent py-2.5 pl-4 pr-2 outline-none text-sm"
                  />
                  <button type="submit" className="flex items-center justify-center px-4 py-2.5 hover:text-blue transition-colors">
