      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 py-12">
          <div className="flex flex-col items-center md:items-start gap-3">
            <Link href="/"><Image src="/images/logo/logo.svg" alt="FidesKey" width={130} height={45} /></Link>
            <p className="text-sm text-dark-4 text-center md:text-left max-w-[200px]">Tu tienda de artículos de fiesta en Uruguay</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/fideskey" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white shadow-1 flex items-center justify-center text-dark hover:text-blue hover:shadow-md transition-all">
              ...
              <a href="https://facebook.com/fideskey" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white shadow-1 flex items-center justify-center text-dark hover:text-blue hover:shadow-md transition-all">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://wa.me/59874923477" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-full bg-white shadow-1 flex items-center justify-center text-dark hover:text-blue hover:shadow-md transition-all">
